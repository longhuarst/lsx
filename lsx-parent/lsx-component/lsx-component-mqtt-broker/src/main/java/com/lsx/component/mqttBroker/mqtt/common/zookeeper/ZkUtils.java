...
public class ZkUtils {
    ...
    public boolean createNode(String path, String data, CreateMode mode) {
        ...
        try {
            ...
            logger.error("create node fail! path: {}, error: {}", path, e);
        }
        return Boolean.FALSE;
    }
    ...
    public boolean deleteNode(String path, Integer version) {
        ...
        try {
            ...
            logger.error("delete node fail! path: {}, error: {}", path, e);
        }
        return Boolean.FALSE;
    }
    ...
    public byte[] getNodeData(String path) {
        ...
        try {
            ...
            logger.error("get node data fail! path: {}, error: {}", path, e);
        }
        return null;
    }
    ...
    public Stat exists(String path) {
        ...
        try {
            ...
            logger.error("check node exists fail! path: {}, error: {}", path, e);
        }
        return null;
    }
    ...
    public boolean setNodeData(String path, byte[] data, Integer version) {
        ...
        try {
            ...
            logger.error("set node data fail! path: {}, error: {}", path, e);
        }
        return Boolean.FALSE;
    }
...
//                }
            ...
            logger.error("listen path children cache fail! path:{} , error:{}", path, e);
        }
        return Boolean.FALSE;
    }
    ...
    public Map<String, String> readTargetChildsData(String path) {
        ...
        try {
            ...
            logger.error("get target childs data fail!, path:{} , error:{}", path, e);
        }
        return map;
